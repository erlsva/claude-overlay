...
test("Discord TTS messages show sender and prompt in one safe code block", () => {
  assert.equal(
    formatDiscordClipMessage("(TTS:0123456789abcdef0123456789abcdef)", "RaeArx_", "Cheer200 Every time I come into chat"),
    "(TTS:0123456789abcdef0123456789abcdef)\n```\nRaeArx_: Cheer200 Every time I come into chat\n```",
  );
  const escaped = formatDiscordClipMessage("(TTS:0123456789abcdef0123456789abcdef)", "Viewer", "```unexpected fence```");
